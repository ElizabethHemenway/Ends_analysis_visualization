...
CG=$(find ./data/ -type f -name '*CG*')
CGn=$(find ./data/ -type f -name '*CG*' -execdir basename '{}' ';')
...
echo $endsout$base
#$script_path_2"ends_analysis_eah.sh"  -O 2000 -I 2000 -r '$file' -o $endsout$base'_TE_CHH' -i '$CHHdata'  -n '$CHHnames' -w 100  -V 6 -M -R 
#$script_path_2"ends_analysis_eah.sh"  -O 2000 -I 2000 -r '$file' -o $endsout$base'_TE_CHG' -i '$CHGdata'  -n '$CHGnames' -w 100  -V 6 -M -R 
$script_path_2"ends_analysis_eah.sh"  -O 2000 -I 2000 -r '$file' -o $endsout$base'_TE_CG' -i '$CGdata' -n '$CGnames' -w 100 -V 6 -M -R 
